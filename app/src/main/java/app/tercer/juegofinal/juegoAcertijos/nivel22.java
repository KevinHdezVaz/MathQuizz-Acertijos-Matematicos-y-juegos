...
public class nivel22 extends AppCompatActivity {
    ...
    public void mostrarInfo() {
        ...
        btnVamo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nivel22.this,nivel6.class));
                finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel22.this;
                        ...
                        Toastie.info(nivel22.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel22.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
