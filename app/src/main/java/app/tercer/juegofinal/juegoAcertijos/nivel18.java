...
public class nivel18 extends AppCompatActivity {
    EditText editText;
    String varResultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel18);
        ...
        PreferenciaNvl.setLevel(getApplicationContext(), 18 /* Nivel */);
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel18.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel18.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
                varResultado = editText.getText().toString();
                if (varResultado.equals("98")) {

                    PreferenciaNvl.lvlCompleto(getApplicationContext(),18); //ya lo paso
    ...
    public void mostrarInfo() {
        ...
        btnVamo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nivel18.this,nivel19.class));
                finish();
            }
        });
        ...
        msjResuelto.setText(getString(R.string.princi21));
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel18.this;
                        ...
                        Toastie.info(nivel18.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel18.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void Pista(){
        ...
        txtResultado.setText(getString(R.string.princi22));
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void Respuesta(){
        ...
        txtRespuesta.setText(getString(R.string.resp)+ " 98");
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel18.this, MenuJuegos.class));
        finish();
    }
}
