...
public class nivel9 extends AppCompatActivity {
    EditText editText;
    String varResultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel9);
        ...
        PreferenciaNvl.setLevel(getApplicationContext(), 9 /* Nivel */);

        getSharedPreferences(PreferenciaNvl.Shared_Preferences, Context.MODE_PRIVATE).edit().putInt(PreferenciaNvl.Last_Level, 9).apply();
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel9.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel9.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
                varResultado = editText.getText().toString();
                if (varResultado.equals("2")) {

                    PreferenciaNvl.lvlCompleto(getApplicationContext(),9); //ya lo paso
    ...
    public void mostrarInfo() {
        ...
        btnVamo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nivel9.this,nivel10.class));
                finish();
            }
        });
        ...
        msjResuelto.setText(getString(R.string.princi12));
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel9.this;
                        ...
                        Toastie.info(nivel9.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel9.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void Pista(){
        ...
        txtResultado.setText(getString(R.string.princi13));
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void Respuesta(){
        ...
        txtRespuesta.setText(getString(R.string.resp)+ " 2");
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel9.this, MenuJuegos.class));
        finish();
    }
}
