...
public class nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel6.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel6.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
                varResultado = editText.getText().toString();
                if (varResultado.equals("10")) {
    ...
    public void mostrarInfo() {
        ...
        btnVamo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nivel6.this,nivel7.class));
                finish();
            }
        });
        ...
        msjResuelto.setText(getString(R.string.princi7));
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel6.this;
                        ...
                        Toastie.info(nivel6.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel6.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void Pista(){
        ...
        txtResultado.setText(getString(R.string.princi8));
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void Respuesta(){
        ...
        txtRespuesta.setText(getString(R.string.resp)+ " 10");
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel6.this, MenuJuegos.class));
        finish();
    }
}
