...
public class nivel16 extends AppCompatActivity {
    EditText editText;
    String varResultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel16);
        ...
        PreferenciaNvl.setLevel(getApplicationContext(), 16 /* Nivel */);
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel16.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel16.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
                varResultado = editText.getText().toString();
                if (varResultado.equals("18")) {

                    PreferenciaNvl.lvlCompleto(getApplicationContext(),16); //ya lo paso
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel16.this;
                        ...
                        Toastie.info(nivel16.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel16.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void Respuesta(){
        ...
        txtRespuesta.setText(getString(R.string.resp)+ " 18");
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel16.this, MenuJuegos.class));
        finish();
    }
}
