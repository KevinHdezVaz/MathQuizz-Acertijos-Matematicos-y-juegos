...
public class nivel27 extends AppCompatActivity {
    EditText editText;
    String varResultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel27);
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel27.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel27.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
                ...
                if (anunciopista == false) { //osea que si no lo han visto
                    if (pista.isLoaded()) {
                        ...
                        Activity activityContext = nivel27.this;
                        ...
                        Toastie.info(nivel27.this,getString(R.string.ayuda3),Toast.LENGTH_SHORT).show();
        ...
        btnad2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(anunciopista==false){
                    Toastie.info(nivel27.this,getString(R.string.ayuda4),Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel27.this, MenuJuegos.class));
        finish();
    }
}
