...
public class nivel13 extends AppCompatActivity {
    EditText editText;
    String varResultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel13);
        ...
        entrarx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contador++;
                if(contador==5){
                    Toastie.warning(nivel13.this,getString(R.string.ayuda1), Toast.LENGTH_SHORT).show();
                }
                if(contador==8){
                    Toastie.warning(nivel13.this,getString(R.string.ayuda2),Toast.LENGTH_SHORT).show();
                }
                varResultado = editText.getText().toString();
                if (varResultado.equals("79")) {

                    PreferenciaNvl.lvlCompleto(getApplicationContext(),13); //ya lo paso
    ...
    public void Respuesta(){
        ...
        txtRespuesta.setText(getString(R.string.resp)+ " 79");
        epicDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public void onBackPressed(){
        startActivity(new Intent(nivel13.this, MenuJuegos.class));
        finish();
    }
}
