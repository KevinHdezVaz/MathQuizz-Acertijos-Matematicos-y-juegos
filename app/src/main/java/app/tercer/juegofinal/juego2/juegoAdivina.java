package app.tercer.juegofinal.juego2;
...
import app.tercer.juegofinal.juego1.QuizContext;
...
public class juegoAdivina extends AppCompatActivity {
    ...
    public void comprobar(View v) {
        ...
        if (numero.equals(""))
        {
            Toastie.warning(this, getString(R.string.pasa2), Toast.LENGTH_LONG).show();
        }
        else
        {
            ...
            if (numero_usuario > n_maximo)
            {
                ...
                Toastie.topError(this, getString(R.string.pasa), Toast.LENGTH_SHORT).show();
            }
            else
            {
